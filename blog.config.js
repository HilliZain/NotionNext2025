...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hilli Zain', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Let Technology Unlock the World of Magic', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.hillizain.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Hilli Zain, Space', // 网站关键词 英文逗号隔开
